    ...
    const UI = {
        ...
        createButtonGroup: (buttonsConfig) => {
            ...
            buttonsConfig.forEach(config => {
                // Skip buttons that should be hidden
            ...
            try {
                ...
                if (hasMedia) {
                    ...
                    if (!elements.postActions.querySelector(`.${CSS.BTN}`)) {
                        ...
                        elements.postActions.append(downloadAllButton, galleryButton);
